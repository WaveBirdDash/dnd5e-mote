...
**Dwarves** are short, broad humanoids who immigrated to [Esterfell](../../../ch-4-esterfell-gazetteer/esterfell/index.md) in the first few waves of ships. Various groups of dwarves settled across [Lenya](../../../ch-4-esterfell-gazetteer/esterfell/lenya/index.md), [Yggru](../../../ch-4-esterfell-gazetteer/esterfell/yggru/index.md), and [Barria](../../../ch-4-esterfell-gazetteer/esterfell/barria.md), distributing themselves based on traditional trades and environmental preferences carried over from their ancestral lands.
...
_**Walk Without Rhythm.**_ You can take both the Dash and Disengage actions as a single Bonus Action. You can use this trait a number of times equal to your Proficiency Bonus, and you regain all expended uses when you finish a Long Rest.
