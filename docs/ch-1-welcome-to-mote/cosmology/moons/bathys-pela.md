...
"Bathýs" and "Pela" both source their names from a pre-[Esterfell](../../../ch-4-esterfell-gazetteer/esterfell/index.md) human language; the former means "deep", and the latter is from "pélagos" meaning "open sea".
